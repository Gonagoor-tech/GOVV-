...
const Footer = () => {
  return (
    <footer className="bg-go-black text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="text-3xl font-montserrat font-bold mb-4 block">
              Go <span className="text-go-blue">VV</span>
            </Link>
            <p className="text-gray-400 mb-6 max-w-md">
              Go Further. Go Freely. Go VV. Premium electric bicycles for modern urban mobility in India.
            </p>
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="bg-gray-800 border border-gray-700 rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:border-go-blue focus:outline-none flex-1"
                />
                <button className="bg-go-blue text-white px-6 py-2 rounded-lg font-semibold hover:bg-go-blue-dark transition-colors">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Our Bikes', 'Technology', 'About Us', 'Blog', 'Contact'].map((item) => (
                <li key={item}>
                  <Link
                    to={`/${item.toLowerCase().replace(' ', '-')}`}
                    className="text-gray-400 hover:text-go-blue transition-colors"
                  >
                    {item}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-6">
              <a href="#" className="text-gray-400 hover:text-go-blue transition-colors">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 Go VV. All rights reserved. | Privacy Policy | Terms of Service</p>
        </div>
      </div>
    </footer>
  );

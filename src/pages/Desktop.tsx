  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen w-full">
      <div className="bg-gradient-to-br from-slate-50 to-blue-50 w-full relative">
        {/* Hero Section */}
        <div id="home" className="h-[1024px] md:h-[1024px] sm:h-[800px] relative overflow-hidden w-screen">
          <div className="relative w-full h-[1019px] top-[5px]">
            {/* Top section */}
            <div className="absolute w-full h-[710px] top-0 left-0">
              <div className="h-[710px] w-full relative">
                {/* Navigation Menu */}
                    ...
                    <div className="flex gap-2 md:gap-3 md:mr-auto">
                      {leftNavItems.map((item, index) => (
                        <a
                          ...
                          className={`${glassCardStyle} w-[90px] md:w-[120px] h-[40px] md:h-[50px] flex items-center justify-center [font-family:'Poppins',Helvetica] font-bold text-black text-sm md:text-lg cursor-pointer hover:scale-105 transition-transform`}
                        >
                ...
                {/* Background and bike image */}
                <div className="absolute w-screen h-[690px] top-0 left-1/2 transform -translate-x-1/2 bg-[url(/figmaAssets/vector-5-1.svg)] bg-cover bg-center" />
                <img
                className="absolute w-[480px] md:w-[720px] h-[337px] md:h-[506px] top-[240px] md:top-[203px] left-2 md:left-0 z-10"
                alt="Electric Bike"
                src="/figmaAssets/vector-121.svg"
              />

              {/* Specification Cards - Hidden on mobile, shown on md+ */}
              ...
              {/* Mobile Specification Cards - Grid layout */}
              <div className="block md:hidden absolute top-[120px] left-4 right-4 z-15">
                    ...
                    >
                      <CardContent className="p-0 flex flex-col items-center">
                        <img
                          ...
                          src={card.icon}
                        />
                        <div className="text-center [font-family:'Poppins',Helvetica] font-bold text-black text-xs">
                          {card.title}
                          <br />
                          <span className="text-[10px]">{card.description}</span>
                        </div>
                      </CardContent>
                    </Card>
                  ))}
          ...
          {/* Bottom section */}
          <div className="absolute w-screen h-[410px] top-[609px] left-1/2 transform -translate-x-1/2">
            <div className="h-[410px] relative">
              {/* Top curve separator */}
              <div className="absolute w-full h-[92px] top-0 left-0">
                <img
                  className="absolute w-full h-[95px] -top-0.5 left-0"
                  alt="Vector"
              ...
              {variants.map((variant, index) => (
                <div
                  key={`variant-${index}`}
                  className="absolute w-[260px] h-20 rounded-[35px] shadow-[inset_0px_4px_4px_#665e3440] blur-[0.45px] backdrop-blur-[0.7px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(0.7px)_brightness(100%)] bg-[linear-gradient(35deg,rgba(218,217,164,1)_43%,rgba(116,115,87,1)_100%)]"
                  style={{ top: variant.top, left: variant.left }}
                >
                  <img
                    className="absolute w-[111px] h-[71px] top-4 left-2"
                    alt="Variant"
                    src={variant.imageSrc}
                  />
                  <div className="absolute top-6 left-[120px] [font-family:'Poppins',Helvetica] font-bold text-black text-sm">
                    {variant.title}
                  </div>
                </div>
              ))}
              ...
              {/* Content section */}
              <div className="absolute w-full h-[376px] top-[34px] left-0">
                <div className="w-full h-[376px] relative">
                  <div className="absolute w-full h-[377px] top-0 left-0 bg-[url(/figmaAssets/vector-6-1.svg)] bg-cover bg-center">
                    <div className="absolute w-[390px] top-[70px] left-[120px] [font-family:'Poppins',Helvetica] font-bold text-white text-2xl tracking-[0] leading-[normal] whitespace-nowrap">
                      MAXIMIZE YOUR PRODUCTIVITY
                    </div>

                    <div className="absolute w-[615px] top-[110px] left-[115px] [font-family:'Poppins',Helvetica] font-bold text-[#b5d33c] text-[50px] tracking-[0] leading-[normal]">
                      GOVV - CAMPUS RIDER 1
                    </div>

                    <div className="absolute w-[779px] top-[186px] left-[115px] [font-family:'Poppins',Helvetica] font-bold text-white text-xl tracking-[0] leading-[normal]">
                    ...
                    <div className="absolute w-[157px] top-[66px] left-[989px] [font-family:'Poppins',Helvetica] font-bold text-white text-2xl tracking-[0] leading-[normal]">
                      Variants:
                    </div>
                  </div>
                </div>
